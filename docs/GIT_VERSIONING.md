...
Exemple:
- `former-cep-v2.1.7-rc.1` (val)
- `former-cep-v2.1.7-rc.2` (val apres correction)
- `former-cep-v2.1.7` (final: prod + archive)
- `former-cep-archive-v2.1.7` (optionnel, meme commit que prod)
...
7. Tagger le commit final en `former-cep-vX.Y.Z`.
...
- CEP val: `former-cep-vX.Y.Z-rc.N`
- CEP final: `former-cep-vX.Y.Z`
- CEP archive (optionnel): `former-cep-archive-vX.Y.Z`
- CFFE final: `former-cffe-vX.Y.Z`
- DGCS final: `former-dgcs-vX.Y.Z`
