CREATE TABLE
    former22_invoice (
        ...
        createdAt DATETIME NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Datetime of invoice creation',
        seances TEXT COMMENT 'Session events',
        inscriptionStatus TEXT COMMENT 'The status of the inscription'
    ) DEFAULT CHARSET UTF8 COMMENT '';

ALTER TABLE former22_invoice
ADD
